...
class FilterOperator:
    ...
    def do(self):
        ...
        for root, _subdirectories, files in tqdm(os.walk(img_dir), "Processing dataset file structure"):
            for file in files:
...
class MergeMetaInformationOperator:
    ...
    def find_all_meta(self):
        files = [
            os.path.join(directory, "normalized_meta.csv")
            for directory in os.listdir(self.input_dir)
            if directory != "meta_info.csv" and directory != "datasets.zip"
        ]
        return files
...
class ResizeOperator:
    ...
    def do(self):
        ...
        for file in tqdm(
            os.listdir(r"E:\University\HИP\Project\src\etl\datasets\stanford\car_ims"), "Resizing dataset "
        ):
            file_path = os.path.join(r"E:\University\HИP\Project\src\etl\datasets\stanford\car_ims", file)
...
class CreateSubset:
    ...
    def do(self):
        ...
        for _index, bmw_row in bmw_subset.iterrows():
...
if __name__ == "__main__":
    # FilterOperator(r"E:\University\HИP\Project\src\etl\datasets\carconnection", "data").do()
    # MergeMetaInformationOperator(r"E:\University\HИP\Project\src\etl\datasets").do()
    # ResizeOperator(r"E:\University\HИP\Project\src\etl\datasets").do()
    CreateSubset(
        r"E:\University\HИP\Project\src\etl\datasets", r"E:\University\HИP\Project\src\etl\datasets\subset"
    ).do()
